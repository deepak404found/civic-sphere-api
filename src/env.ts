...
export const vars = {
    ...
    SWAGGER_DEVELOPMENT_URL: process.env?.SWAGGER_DEVELOPMENT_URL || 'https://deepak-test.gimbooks.com/',
    SWAGGER_PRODUCTION_URL: process.env?.SWAGGER_PRODUCTION_URL || 'https://dk404.gimbooks.com/',
